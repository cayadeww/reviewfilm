    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-4 rounded-lg shadow-md flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-lg font-semibold">Total Subscriber</h2>
                ...
                <div class="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-4 rounded-lg shadow-md flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-lg font-semibold">Total Authors</h2>
